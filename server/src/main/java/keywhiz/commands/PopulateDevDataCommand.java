...
public class PopulateDevDataCommand extends ConfiguredCommand<KeywhizConfig> {
  public PopulateDevDataCommand() {
    super("populate-dev-data", "Fills the database with development data.");
  }
  ...
  @Override protected void run(Bootstrap<KeywhizConfig> bootstrap, Namespace namespace,
    ...
    if (!config.getEnvironment().equals("development")) {
      throw new IllegalArgumentException("cannot call populate-dev-data in non-development environment");
    }

    DataSource dataSource = config.getDataSourceFactory()
        .build(new MetricRegistry(), "populate-dev-data-datasource");
